...
const words = ['viratkohli', 'devilliers', 'buttler', 'bhuvaneshwar', 'steyn', 'miller', 'philander', 'warner', 'kallis', 'peterson','pollard','tewatia',
'bumrah','sangakara','jayawardane','muralidharan','anderson','warne','gilchrist','boucher','ashwin','dhoni'];
